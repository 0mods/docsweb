...
![animations](@site/static/img/doc/titles/Animations0.webp "Спасибо Uertyk_ [uertyk_] за титульник")
...
npc.play {
  animation = "punch"
  layerMode = LayerMode.OVERRIDE
  playMode = PlayType.ONCE
  speed = 1.16f
}
```
...
Список все анимаций пожно получить из команды `/hollowengine model <path/to/model>`.  
