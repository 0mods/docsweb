...
<div id="preview-content">
  ...
  <div align="left" id="content">
    <div align="center" style={{ "color": "red", "font-weight": "700" }}>Стандартый метод может работать криво. Используйте из пака `HollowEngine: Fixer` на дискорд сервере в канале `#script-templates`!</div>
    <br />
```kts
