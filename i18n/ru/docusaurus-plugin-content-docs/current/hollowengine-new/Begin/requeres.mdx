...
```mermaid 
graph TD;
   HollowEngine-->[Необходимо] HollowCore;
   HollowEngine-->[По желанию] FTBTeams;
   HollowEngine-->[По желанию, если FTBTeams установлен] Photon;
   FTBTeams-->[Необходимо] FTBLibrary;
   FTBLibrary-->[Необходимо] Architectury;
   HollowCore-->[Необходимо] KotlinForForge;
```
