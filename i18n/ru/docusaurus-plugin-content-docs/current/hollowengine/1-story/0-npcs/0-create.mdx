...
val npcID = npc(
  ...
  rotation = rotation(180, 0), // В какую сторону будет смотреть НИП когда заспавнится по осям pitch и yaw
  world = "my_mod_id:my_dimension_id", // Измерение, в котором будет заспавнен НИП
