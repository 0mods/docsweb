...
![1 раз](@site/static/img/doc/playType-ONCE-aPNG.png)
...
![бесконечно раз](@site/static/img/doc/playType-LOOPED-aPNG.png)
...
![До последнего](@site/static/img/doc/playType-FREEZE-aPNG.png)
...
![Остановите, остановите! Витя, Витя где-то выпал...](@site/static/img/doc/playType-STOP-aPNG.png)
