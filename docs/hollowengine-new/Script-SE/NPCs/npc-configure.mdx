...
```
> Designations:
> - `texture` - Name of the texture, that is on the model.
> - `nickname` - Nickname of a player, who has a license.
:::
...
```jsx
    animation[AnimationType.<type>] = "<new_animationName>" // The replacement of the current animation to the new animation
```
> Designations:
