...
val <npcID> by NPCEntity.creating{
    ...
    world ="<dimenstionID>" // Измерение, в котором должен появится НИП
...
<td style={{width: '50%', verticalAlign: 'top'}}>
  <image style={{float: 'right', marginLeft: '10px'}}>
    <img src="https://0mods.team/hollowengine/.resources/npc_base.png" alt="Basic NPC" />
  </image>
</td>
</tr>

<Tabs>
<TabItem value="BaseNPC" label="Базовый НИП">

<image style={{float: 'right', marginLeft: '10px'}}>
  <img src="../../.resources/npc_base.png" alt="Your Image" />
</image>
```kts title="Базовый НИП"
// Для спавна базового NPC, будет достаточно указать: Имя и Позиция
val npc by NPCEntity.creating{
...
<TabItem value="CustomNPC" label="Кастомный НИП">
