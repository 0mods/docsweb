...
:::info
Вспомни то, что ты читал [о 'ResourceLocation'](../../0-begin/6-resources.mdx)
...
Вот другой пример с другим `modID`:  Если путь: `assets/city/humans/petrov.gltf`, то результат такой:
```kts
