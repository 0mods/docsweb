...
To write scripts you can use anything, VSCode, SublimeText 4, Intellij IDEA, even Notepad. But if you are too lazy to mess with all this, we recommend you to try the built-in development environment, to open it, click on the gear in the pause menu of the game.
